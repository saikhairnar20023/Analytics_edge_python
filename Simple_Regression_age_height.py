# -*- coding: utf-8 -*-
"""
Created on Fri Nov 12 09:26:34 2021
...
dataset = pd.read_csv('C:/Users/ABC/Documents/Business_analytics_python/DATA/age_height_data.csv')
print(type(dataset))
...
#Create a DataFrame
df1 = {'Actual Age':y_test,
'Predicted Age':y_pred}
df1 = pd.DataFrame(df1,columns=['Actual Age','Predicted Age'])
print(df1)
