# -*- coding: utf-8 -*-
"""
Created on Mon Jan 30 18:20:15 2023
...
plt.hist(values,5, histtype='step', color='green', label='Test Score Data')
...
values = [82,76,24,40,67,62,75,78,71,32,98,89,78,67,72,82,87,66,56,52]
plt.hist(values,18, histtype='bar', color='cyan', label='Test score Data',edgecolor='black')
